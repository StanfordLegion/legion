...
legion_cxx_tests = [
    ...
    ['test/output_requirements/output_requirements', ['-index', '-lg:enable_pointwise_analysis']],
    ['test/output_requirements/output_requirements', ['-index', '-replicate', '-lg:enable_pointwise_analysis']],
    ...
    ['test/mapper/mapper', []],
    ['test/auto_tracing/auto_tracing', ['-level', 'auto_trace=2']],
]
