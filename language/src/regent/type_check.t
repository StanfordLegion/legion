...
function type_check.expr_partition(cx, node)
  ...
  -- This should pass because we fell back on std.incomplete above
...
function type_check.expr_partition_by_field(cx, node)
  ...
  local expr_type = std.partition(std.disjoint, node.completeness or std.incomplete, region_symbol, colors_symbol)
