...
ast.unspecialized.expr:leaf("Image", {"partition", "region", "parent"})
ast.unspecialized.expr:leaf("Preimage", {"partition", "region"})
...
ast.typed.expr:leaf("Image", {"partition", "region", "parent"})
ast.typed.expr:leaf("Preimage", {"partition", "region"})
