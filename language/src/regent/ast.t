...
ast.unspecialized.stat:leaf("ParallelizeWith", {"exprs", "block"})
...
ast.specialized.stat:leaf("ParallelizeWith", {"exprs", "block"})
...
ast.typed.stat:leaf("ParallelizeWith", {"exprs", "block"})
