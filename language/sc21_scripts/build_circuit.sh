...
SAVEOBJ=1 STANDALONE=1 OBJNAME=./circuit.noidx $root_dir/../regent.py $root_dir/../examples/circuit_sparse.rg -fflow 0 -fopenmp 0 -fcuda 1 -fcuda-offline 1 -fcuda-arch pascal -findex-launch 0 -ffuture 0
