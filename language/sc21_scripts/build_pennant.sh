...
SAVEOBJ=1 STANDALONE=1 OBJNAME=./pennant.noidx $root_dir/../regent.py $root_dir/../examples/pennant.rg -fflow 0 -fopenmp 0 -fcuda 1 -fcuda-offline 1 -fcuda-arch pascal -findex-launch 0
