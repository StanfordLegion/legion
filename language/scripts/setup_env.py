...
def install_llvm(llvm_dir, llvm_install_dir, llvm_version, llvm_use_cmake, cmake_exe, insecure):
    os.mkdir(llvm_dir)
...
def driver(llvm_version, insecure):
    ...
    if not os.path.exists(llvm_dir):
        try:
            install_llvm(llvm_dir, llvm_install_dir, llvm_version, llvm_use_cmake, cmake_exe, insecure)
        except Exception as e:
