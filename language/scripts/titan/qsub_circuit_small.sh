...
for n in 8 4 2 1; do
    for r in 0 1 2 3 4; do
        if [[ ! -f out_"$n"x8_r"$r".log ]]; then
            ...
            aprun -n $n -N 1 -cc none "$root_dir/circuit.spmd8" -npp 10 -wpp 40 -l 100 -p $(( 1024 * 8 )) -pps $(( 1024 / n )) -ll:csize 20000 -ll:rsize 512 -ll:gsize 0 -ll:cpu 8 -ll:io 1 -ll:util 1 -ll:dma 1 | tee out_"$n"x8_r"$r".log
