...
SAVEOBJ=1 STANDALONE=1 OBJNAME=./circuit.python $root_dir/../regent.py $root_dir/../../apps/circuit/python/circuit_sparse_python.rg -fflow 0 -fopenmp 0 -fcuda 1 -fcuda-offline 1 -fcuda-arch pascal
