...
task main()
  ...
  c.legion_coloring_add_point(colors0, 0, [raw(ptr(int, r))](x2))
  c.legion_coloring_add_point(colors0, 0, [raw(ptr(int, r))](x3))
  c.legion_coloring_add_point(colors0, 1, [raw(ptr(int, r))](x4))
  c.legion_coloring_add_point(colors0, 1, [raw(ptr(int, r))](x5))
  c.legion_coloring_add_point(colors0, 1, [raw(ptr(int, r))](x6))
  c.legion_coloring_add_point(colors0, 1, [raw(ptr(int, r))](x7))
  ...
  c.legion_coloring_add_point(colors1, 0, [raw(ptr(int, r))](x1))
  c.legion_coloring_add_point(colors1, 1, [raw(ptr(int, r))](x2))
  c.legion_coloring_add_point(colors1, 1, [raw(ptr(int, r))](x3))
  c.legion_coloring_add_point(colors1, 0, [raw(ptr(int, r))](x4))
  c.legion_coloring_add_point(colors1, 0, [raw(ptr(int, r))](x5))
  c.legion_coloring_add_point(colors1, 1, [raw(ptr(int, r))](x6))
  c.legion_coloring_add_point(colors1, 1, [raw(ptr(int, r))](x7))
  var part1 = partition(disjoint, r, colors1)
  c.legion_coloring_destroy(colors1)

  var colors2 = c.legion_coloring_create()
  c.legion_coloring_add_point(colors2, 0, [raw(ptr(int, r))](x0))
  c.legion_coloring_add_point(colors2, 1, [raw(ptr(int, r))](x1))
  c.legion_coloring_add_point(colors2, 0, [raw(ptr(int, r))](x2))
  c.legion_coloring_add_point(colors2, 1, [raw(ptr(int, r))](x3))
  c.legion_coloring_add_point(colors2, 0, [raw(ptr(int, r))](x4))
  c.legion_coloring_add_point(colors2, 1, [raw(ptr(int, r))](x5))
  c.legion_coloring_add_point(colors2, 0, [raw(ptr(int, r))](x6))
  c.legion_coloring_add_point(colors2, 1, [raw(ptr(int, r))](x7))
