...
do
  for e in r do e.f[0] = 0.3 * (e.x + 1) + 0.7 * (e.y + 1) end
  for e in r do e.g[0].val = 0 end
  for e in r do e.h[0].val = 0 end
end
...
do
  for e in r do
    e.g[0].val = 0.5 * (e.f[0] +
                 ...
                 r[(e - {1, 1}) % r.bounds].f[0] +
                 r[(e - {-2, -2}) % r.bounds].f[0] +
                 r[(e + {1, 0}) % r.bounds].f[0])
  end
end
