...
task main()
  ...
  for t = 0, 3 do
    ...
    -- Scalar communication happens here.
    for i = 0, pieces do
      rot_cb(p[i], a, 137)
    end
  end
  ...
  regentlib.assert(x0.a ==  9823, "test failed")
  regentlib.assert(x1.a == 10153, "test failed")
  regentlib.assert(x2.a == 10027, "test failed")
  regentlib.assert(x3.a == 10152, "test failed")
end
