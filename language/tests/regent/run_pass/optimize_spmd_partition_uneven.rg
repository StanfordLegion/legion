...
--   * partitions with different parent regions
...
task main()
  ...
  var co = c.legion_coloring_create()
  c.legion_coloring_add_point(co, 0, __raw(x0))
  c.legion_coloring_add_point(co, 0, __raw(x1))
  c.legion_coloring_add_point(co, 0, __raw(x2))
  c.legion_coloring_add_point(co, 0, __raw(x3))
  var o = partition(disjoint, r, co)
  c.legion_coloring_destroy(co)
  ...
  var p = partition(disjoint, o0, cp)
