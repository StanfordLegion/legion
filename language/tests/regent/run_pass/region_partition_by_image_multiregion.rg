...
task f()
  ...
  var s = region(ispace(ptr, 4), ptr(int, r, r))
  var y0 = dynamic_cast(ptr(ptr(int, r, r), s), 0)
  var y1 = dynamic_cast(ptr(ptr(int, r, r), s), 1)
  var y2 = dynamic_cast(ptr(ptr(int, r, r), s), 2)
  var y3 = dynamic_cast(ptr(ptr(int, r, r), s), 3)

  @y0 = dynamic_cast(ptr(int, r, r), x1)
  @y1 = dynamic_cast(ptr(int, r, r), x0)
  @y2 = dynamic_cast(ptr(int, r, r), x1)
  @y3 = dynamic_cast(ptr(int, r, r), x2)
