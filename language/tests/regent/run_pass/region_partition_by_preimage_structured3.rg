...
task f()
  ...
  s[{ 0, 0 }] = dynamic_cast(int1d(int, r), 1)
  s[{ 1, 0 }] = dynamic_cast(int1d(int, r), 0)
  s[{ 2, 0 }] = dynamic_cast(int1d(int, r), 1)
  s[{ 3, 0 }] = dynamic_cast(int1d(int, r), 2)
  s[{ 4, 0 }] = dynamic_cast(int1d(int, r), 3)
