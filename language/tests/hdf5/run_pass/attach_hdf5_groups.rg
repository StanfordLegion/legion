...
terra generate_hdf5_file(filename : rawstring, dims : int3d)
  ...
  var ds2id = hdf5.H5Dcreate2(fid, "bob", hdf5.H5T_STD_I64LE, did,
                              hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT)
  --c.assert(ds2id > 0)
  hdf5.H5Dclose(ds2id)

  var g1id = hdf5.H5Gcreate2(fid, "path", 
                             hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT)
  var g2id = hdf5.H5Gcreate2(g1id, "to", 
                             hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT)
  var ds3id = hdf5.H5Dcreate2(g2id, "c", hdf5.H5T_IEEE_F64LE, did,
                              hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT, hdf5.H5P_DEFAULT)
  --c.assert(ds3id > 0)
  hdf5.H5Dclose(ds3id)
  hdf5.H5Gclose(g2id)
...
task main()
  ...
  var r2 = region(is, t)
  var r3 = region(is, t)
  var field_map = array("a", "bob", "/path/to/c")
  ...
  if false then
    ...
    fill_region(r1, 1)
    attach(hdf5, r2.{a, b, c}, filename, regentlib.file_read_write, field_map)
    fill_region(r2, 1)
