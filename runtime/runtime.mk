...
NVCC_FLAGS	+= -DLEGION_MAX_FIELDS=$(MAX_FIELDS)
endif

#Set maximum number of local fields
ifneq ($(strip ${MAX_LOCAL_FIELDS}),)
CC_FLAGS	+= -DLEGION_DEFAULT_LOCAL_FIELDS=$(MAX_LOCAL_FIELDS)
NVCC_FLAGS	+= -DLEGION_DEFAULT_LOCAL_FIELDS=$(MAX_LOCAL_FIELDS)
endif
