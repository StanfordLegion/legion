...
namespace Realm {
  ...
  static void memcpy_1d(uintptr_t dst_base, uintptr_t src_base, size_t bytes)
  {
...
// define DEBUG_MEMCPYS
  ...
  static void memcpy_2d(uintptr_t dst_base, uintptr_t dst_lstride, uintptr_t src_base,
  ...
  static void memcpy_3d(uintptr_t dst_base, uintptr_t dst_lstride, uintptr_t dst_pstride,
  ...
  static void memset_1d(uintptr_t dst_base, size_t bytes, const void *fill_data,
                        size_t fill_size)
  {
    // by subtracting 1 from bases, strides, and lengths, we get LSBs set
    //  based on the common alignment of every parameter in the copy
  ...
  static void memset_2d(uintptr_t dst_base, uintptr_t dst_lstride, size_t bytes,
                        size_t lines, const void *fill_data, size_t fill_size)
  {
    // by subtracting 1 from bases, strides, and lengths, we get LSBs set
    //  based on the common alignment of every parameter in the copy
  ...
  static void memset_3d(uintptr_t dst_base, uintptr_t dst_lstride, uintptr_t dst_pstride,
