...
namespace Realm {
  ...
  struct SubgraphDefinition {
	...
	TARGET_TASK_BASE = 0x0100,
	TARGET_TASK_ARGS,

	TARGET_COPY_BASE = 0x0200,

	TARGET_ARRIVAL_BASE = 0x0300,
	TARGET_ARRIVAL_BARRIER,
	TARGET_ARRIVAL_VALUE,

	TARGET_INSTANCE_BASE = 0x0400,
	TARGET_INSTANCE_ARGS,

	TARGET_ACQUIRE_BASE = 0x0500,

	TARGET_RELEASE_BASE = 0x0600,
      };
