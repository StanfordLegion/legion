...
typedef enum legion_error_t {
  ...
  ERROR_ARGUMENT_MAP_DIMENSIONALITY = 566,
  ERROR_INVALID_FUTURE_MAP_POINT = 567,
  ...
  LEGION_WARNING_MISMATCHED_REPLICATED_FUTURES = 1104,
  LEGION_WARNING_INLINING_NOT_SUPPORTED = 1105,
