...
typedef enum legion_privilege_mode_t {
  ...
  LEGION_COLLECTIVE_MASK = 0x40000000, // For marking collective privileges
  LEGION_WRITE_ONLY      = 0x10000002, // WRITE_PRIV | DISCARD_MASK,
  LEGION_WRITE_DISCARD   = 0x10000007, // READ_WRITE | DISCARD_MASK,
  LEGION_COLLECTIVE_READ_ONLY     = 0x20000001,
  LEGION_COLLECTIVE_REDUCE        = 0x20000004,
  LEGION_COLLECTIVE_READ_WRITE    = 0x20000007,
  LEGION_COLLECTIVE_WRITE_DISCARD = 0x50000006, // Reading is not safe!
