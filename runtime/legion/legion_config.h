...
typedef enum legion_error_t {
  ...
  ERROR_MAPPER_COLLECTIVE_INSTANCE_MISMATCH = 625,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_SYNC_MODEL = 626,  
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NON_POINT = 627,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NOPOINT = 628,
