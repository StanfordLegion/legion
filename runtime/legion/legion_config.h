...
typedef enum legion_error_t {
  ...
  ERROR_MAPPER_COLLECTIVE_INSTANCE_MISMATCH = 624,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_SYNC_MODEL = 625,  
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NON_POINT = 626,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NOPOINT = 627,
