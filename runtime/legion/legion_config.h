...
typedef enum legion_error_t {
  ...
  LEGION_WARNING_DYNAMIC_SHARDING_REG = 1100,
  LEGION_WARNING_SLOW_NON_FUNCTIONAL_PROJECTION = 1101,
  LEGION_WARNING_MISSING_MUST_EPOCH_DOMAIN = 1102,
  LEGION_WARNING_MISMATCHED_REPLICATED_FUTURES = 1103,
