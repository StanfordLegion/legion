...
typedef enum legion_error_t {
  ...
  ERROR_EXCEEDED_CONFIGURATION_LIMIT = 238,
  ERROR_INVALID_PADDED_ACCESSOR = 239,
  ...
  LEGION_WARNING_USER_SPECIFIED_PARTITION_COLOR = 1108,
  ...
  LEGION_FATAL_COMPACT_SPARSE_PADDING = 2015,
