...
typedef enum legion_privilege_mode_t {
  ...
  LEGION_COLLECTIVE_READ_ONLY     = 0x40000001,
  LEGION_COLLECTIVE_REDUCE        = 0x40000004,
  LEGION_COLLECTIVE_READ_WRITE    = 0x40000007,
  LEGION_COLLECTIVE_WRITE_DISCARD = 0x50000007,
