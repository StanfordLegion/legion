...
typedef enum legion_error_t {
  ...
  ERROR_ILLEGAL_PARTIAL_RESTRICTION2 = 174,
  ERROR_ILLEGAL_REDUCTION_REQUEST = 175,
  ERROR_INVALID_MAPPER_OUTPUT2 = 176,
  ERROR_INVALID_MAPPER_OUTPUT3 = 177,
  ERROR_INVALID_MAPPER_OUTPUT4 = 178,
  ERROR_INVALID_MAPPER_OUTPUT5 = 179,
  ...
  ERROR_INSTANCE_FIELD_PRIVILEGE2 = 184,
  ERROR_ILLEGAL_REQUEST_VIRTUAL_INSTANCE = 185,
  ERROR_PARENT_TASK_INLINE = 186,
  ERROR_PARENT_TASK_INLINE2 = 187,
  ERROR_PARENT_TASK_INLINE3 = 188,
  ERROR_REGION_NOT_SUBREGION = 189,
  ERROR_REGION_REQUIREMENT_INLINE = 190,
  ERROR_PRIVILEGES_FOR_REGION = 191,
  ERROR_PARENT_TASK_INLINE4 = 192,
  ERROR_INVALID_MAPPER_OUTPUT6 = 193,
  ERROR_INVALID_MAPPER_OUTPUT7 = 194,
  ERROR_MISSING_INSTANCE_FIELD = 195,
  ERROR_INVALID_MAPPER_OUTPUT8 = 196,
  ERROR_INVALID_MAPPER_OUTPUT9 = 197,
  ERROR_INVALID_MAPPER_OUTPUT10 = 198,
  ERROR_INVALID_MAPPER_OUTPUT11 = 199,
  ERROR_INVALID_MAPPER_OUTPUT12 = 200,
  ERROR_INVALID_MAPPER_OUTPUT13 = 201,
  ERROR_INVALID_MAPPER_OUTPUT14 = 202,
  ERROR_INVALID_MAPPER_OUTPUT15 = 203,
  ERROR_NUMBER_SOURCE_REQUIREMENTS = 204,
  ERROR_COPY_SOURCE_REQUIREMENTS = 205,
  ERROR_COPY_DESTINATION_REQUIREMENT = 206,
  ERROR_COPY_DESTINATION_REQUIREMENT2 = 207,
  ERROR_COPY_LAUNCHER_INDEX = 208,
  ERROR_DESTINATION_INDEX_SPACE = 209,
  ERROR_ALIASED_REQION_REQUIREMENTS = 210,
  ERROR_PROJECTION_REGION_REQUIREMENTS2 = 211,
  ERROR_REQUEST_INVALID_REGION = 212,
  ERROR_FIELD_NOT_VALI2 = 213,
  ERROR_INSTANCE_FIELD_PRIVILEGE3 = 214,
  ERROR_INSTANCE_FIELD_DUPLICATE = 215,
  ERROR_PARENT_TASK_COPY = 216,
  ERROR_PARENT_TASK_COPY2 = 217,
  ERROR_PARENT_TASK_COPY3 = 218,
  ERROR_REGION_NOT_SUBREGION2 = 219,
  ERROR_REGION_REQUIREMENT_COPY = 220,
  ERROR_PRIVILEGES_FOR_REGION2 = 221,
  ERROR_PARENT_TASK_COPY4 = 222,
  ERROR_PARENT_TASK_COPY5 = 223,
  ERROR_INVALID_MAPPER_OUTPUT16 = 224,
  ERROR_INVALID_MAPPER_OUTPUT17 = 225,
  ERROR_MISSING_INSTANCE_FIELD2 = 226,
  ERROR_INVALID_MAPPER_OUTPUT18 = 227,
  ERROR_INVALID_MAPPER_OUTPUT19 = 228,
  ERROR_INVALID_MAPPER_OUTPUT20 = 229,
  ERROR_INVALID_MAPPER_OUTPUT21 = 230,
  ERROR_INVALID_MAPPER_OUTPUT22 = 231,
  ERROR_SOURCE_REGION_REQUIREMENT = 232,
  ERROR_DESTINATION_REGION_REQUIREMENT = 233,
  ERROR_NUMBER_SOURCE_REQUIREMENTS3 = 234,
  ERROR_COPY_SOURCE_REQUIREMENT = 235,
  ERROR_COPY_DESTINATION_REQUIREMENT3 = 236,
  ERROR_INDEX_SPACE_COPY = 237,
  ERROR_INDEX_SPACE_COPY2 = 238,
  ERROR_COPY_LAUNCHER_INDEX2 = 239,
  ERROR_DESTINATION_INDEX_SPACE2 = 240,
  ERROR_INVALID_MAPPER_OUTPUT23 = 241,
  ERROR_INVALID_MAPPER_OUTPUT24 = 242,
  ERROR_MISSING_INSTANCE_FIELD3 = 243,
  ERROR_INVALID_MAPPER_OUTPUT25 = 244,
  ERROR_MAPPER_FAILED_ACQUIRE = 245,
  ERROR_INVALID_MAPPER_OUTPUT26 = 246,
  ERROR_REQUEST_INVALID_REGION2 = 247,
  ERROR_FIELD_NOT_VALID3 = 248,
  ERROR_PARENT_TASK_ACQUIRE = 249,
  ERROR_PARENT_TASK_ACQUIRE2 = 250,
  ERROR_PARENT_TASK_ACQUIRE3 = 251,
  ERROR_REGION_NOT_SUBREGION3 = 252,
  ERROR_REGION_REQUIREMENT_ACQUIRE = 253,
  ERROR_PARENT_TASK_ACQUIRE4 = 254,
  ERROR_REQUEST_INVALID_REGION3 = 255,
  ERROR_FIELD_NOT_VALID4 = 256,
  ERROR_PARENT_TASK_RELEASE = 257,
  ERROR_PARENT_TASK_RELEASE2 = 258,
  ERROR_PARENT_TASK_RELEASE3 = 259,
  ERROR_REGION_NOT_SUBREGION4 = 260,
  ERROR_REGION_REQUIREMENT_RELEASE = 261,
  ERROR_PARENT_TASK_RELEASE4 = 262,
  ERROR_ILLEGAL_MUST_EPOCH = 263,
  ERROR_INVALID_MAPPER_OUTPUT27 = 264,
  ERROR_INVALID_MAPPER_OUTPUT28 = 265,
  ERROR_MUST_EPOCH_DEPENDENCE = 266,
  ERROR_MUST_EPOCH_DEPENDENCE2 = 267,
  ERROR_PARENT_TASK_PARTITION = 268,
  ERROR_REQUEST_INVALID_REGION4 = 269,
  ERROR_FIELD_NOT_VALID5 = 270,
  ERROR_INSTANCE_FIELD_PRIVILEGE4 = 271,
  ERROR_INSTANCE_FIELD_DUPLICATE2 = 272,
  ERROR_PARENT_TASK_FILL = 273,
  ERROR_PARENT_TASK_FILL2 = 274,
  ERROR_PARENT_TASK_FILL3 = 275,
  ERROR_REGION_NOT_SUBREGION5 = 276,
  ERROR_FIELD_NOT_VALID2 = 277,
  ERROR_REGION_REQUIREMENT_FILL = 278,
  ERROR_PRIVILEGES_REGION_SUBSET = 279,
  ERROR_PARENT_TASK_FILL4 = 280,
  ERROR_INDEX_SPACE_FILL = 281,
  ERROR_INDEX_SPACE_FILL2 = 282,
  ERROR_INDEX_SPACE_FILL3 = 283,
  ERROR_ILLEGAL_FILE_ATTACHMENT = 284,
  ERROR_REQUIREMENTS_INVALID_REGION2 = 285,
  ERROR_FIELD_NOT_VALID6 = 286,
  ERROR_INSTANCE_FIELD_PRIVILEGE5 = 287,
  ERROR_INSTANCE_FIELD_DUPLICATE3 = 288,
  ERROR_PARENT_TASK_ATTACH = 289,
  ERROR_PARENT_TASK_ATTACH2 = 290,
  ERROR_PARENT_TASK_ATTACH3 = 291,
  ERROR_REGION_NOT_SUBREGION6 = 292,
  ERROR_REGION_REQUIREMENT_ATTACH = 293,
  ERROR_PARENT_TASK_ATTACH4 = 294,
  ...
  ERROR_INVALID_REGION_HANDLE2 = 301,
  ERROR_INVALID_PARTITION_HANDLE2 = 302,
  ERROR_PROJECTION_REGION_REQUIREMENT = 303,
  ERROR_NONDISJOINT_PARTITION_SELECTED = 304,
  ERROR_FIELD_NOT_VALID7 = 305,
  ERROR_INSTANCE_FIELD_PRIVILEGE6 = 306,
  ERROR_INSTANCE_FIELD_DUPLICATE4 = 307,
  ERROR_PARENT_TASK_TASK2 = 308,
  ERROR_PARENT_TASK_TASK3 = 309,
  ERROR_PARENT_TASK_TASK4 = 310,
  ERROR_REGION_NOT_SUBREGION7 = 311,
  ...
  ERROR_INVALID_MAPPER_OUTPUT29 = 316,
  ERROR_INVALID_MAPPER_OUTPUT30 = 317,
  ERROR_INVALID_MAPPER_OUTPUT31 = 318,
  ERROR_MISSING_INSTANCE_FIELD4 = 319,
  ERROR_INVALID_MAPPER_OUTPUT32 = 320,
  ERROR_INVALID_MAPPER_OUTPUT33 = 321,
  ERROR_INVALID_MAPPER_OUTPUT34 = 322,
  ERROR_PARENT_TASK_TASK5 = 323,
  ERROR_INVALID_MAPPER_OUTPUT35 = 324,
  ERROR_INVALID_MAPPER_OUTPUT36 = 325,
  ERROR_INVALID_MAPPER_OUTPUT37 = 326,
  ERROR_INVALID_MAPPER_OUTPUT38 = 327,
  ERROR_INVALID_MAPPER_OUTPUT39 = 328,
  ERROR_INVALID_MAPPER_OUTPUT40 = 329,
  ERROR_MISSING_INSTANCE_FIELD5 = 330,
  ERROR_INVALID_MAPPER_OUTPUT41 = 331,
  ERROR_INVALID_MAPPER_OUTPUT42 = 332,
  ERROR_INVALID_MAPPER_OUTPUT43 = 333,
  ERROR_INVALID_MAPPER_OUTPUT44 = 334,
  ERROR_INVALID_MAPPER_OUTPUT45 = 335,
  ERROR_INVALID_MAPPER_OUTPUT46 = 336,
  ERROR_INVALID_MAPPER_OUTPUT47 = 337,
  ERROR_INVALID_MAPPER_OUTPUT48 = 338,
  ERROR_INVALID_MAPPER_OUTPUT49 = 339,
  ERROR_INVALID_MAPPER_OUTPUT50 = 340,
  ERROR_INVALID_MAPPER_OUTPUT51 = 341,
  ERROR_INVALID_MAPPER_OUTPUT52 = 342,
  ERROR_INVALID_MAPPER_OUTPUT53 = 343,
  ERROR_INVALID_LOCATION_CONSTRAINT = 344,
  ERROR_INVALID_MAPPER_OUTPUT54 = 345,
  ERROR_INVALID_MAPPER_OUTPUT55 = 346,
  ERROR_MAPPER_REQUESTED_PROFILING = 347,
  ERROR_INVALID_MAPPER_OUTPUT56 = 348,
  ERROR_INVALID_MAPPER_OUTPUT57 = 349,
  ERROR_INVALID_MAPPER_OUTPUT58 = 350,
  ERROR_INVALID_MAPPER_OUTPUT59 = 351,
  ERROR_INVALID_MAPPER_OUTPUT60 = 352,
  ERROR_INVALID_MAPPER_OUTPUT61 = 353,
  ERROR_INVALID_MAPPER_OUTPUT62 = 354,
  ERROR_PREDICATED_TASK_LAUNCH2 = 355,
  ...
  ERROR_INDEX_SPACE_TASK2 = 360,
  ERROR_INDEX_SPACE_TASK3 = 361,
  ERROR_INVALID_MAPPER_OUTPUT63 = 362,
  ERROR_TRACE_VIOLATION_RECORDED = 363,
  ERROR_TRACE_VIOLATION_OPERATION = 364,
  ERROR_TRACE_VIOLATION_OPERATION2 = 365,
  ERROR_INVALID_MAPPER_REQUEST = 366,
  ERROR_INVALID_MAPPER_REQUEST2 = 367,
  ERROR_INVALID_MAPPER_REQUEST3 = 368,
  ERROR_INVALID_MAPPER_REQUEST5 = 369,
  ERROR_INVALID_MAPPER_REQUEST6 = 370,
  ERROR_INVALID_MAPPER_REQUEST7 = 371,
  ERROR_INVALID_REGION_ARGUMENTS = 372,
  ERROR_INVALID_MAPPER_CONTENT = 373,
  ERROR_INVALID_DUPLICATE_MAPPER = 374,
  ERROR_INVALID_UNLOCK_MAPPER = 375,
  ERROR_PARENT_TASK_INLINE5 = 376,
  ERROR_ILLEGAL_RUNTIME_REMAPPING = 377,
  ERROR_UNABLE_FIND_TASK_LOCAL = 378,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE = 379,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE2 = 380,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE3 = 381,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE4 = 382,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE5 = 383,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE6 = 384,
  ERROR_INDEXPARTITION_NOT_SAME_INDEX_TREE7 = 385,
  ...
  ERROR_EXCEEDED_MAXIMUM_NUMBER_LOCAL_FIELDS2 = 390,
  ERROR_UNABLE_ALLOCATE_LOCAL_FIELD2 = 391,
  ERROR_PREDICATED_TASK_LAUNCH_FOR_TASK = 392,
  ERROR_PREDICATED_INDEX_TASK_LAUNCH = 393,
  ERROR_PREDICATED_INDEX_TASK_LAUNCH2 = 394,
  ERROR_ATTEMPTED_INLINE_MAPPING_REGION = 395,
  ERROR_ATTEMPTED_INLINE_MAPPING_REGION2 = 396,
  ERROR_ATTEMPTED_ATTACH_HDF5 = 397,
  ERROR_ATTEMPTED_ATTACH_HDF5_2 = 398,
  ERROR_ILLEGAL_PREDICATE_CREATION = 399,
  ERROR_ILLEGAL_PREDICATE_CREATION2 = 400,
  ERROR_ILLEGAL_NESTED_TRACE2 = 401,
  ...
  ERROR_ILLEGAL_CREATE_INDEX_SPACE_UNION2 = 433,
  ERROR_ILLEGAL_CREATE_INDEX_SPACE_INTERSECTION = 434,
  ERROR_ILLEGAL_CREATE_INDEX_SPACE_INTERSECTION2 = 435,
  ...
  ERROR_ILLEGAL_EXECUTE_INDEX_SPACE2 = 450,
  ...
  ERROR_ILLEGAL_ACQUIRE_OPERATION2 = 458,
  ERROR_ILLEGAL_RELEASE_OPERATION2 = 459,
  ...
  ERROR_ILLEGAL_PREDICATE_CREATION3 = 467,
  ERROR_ILLEGAL_PREDICATE_CREATION4 = 468,
  ...
  ERROR_INVALID_PENDING_CHILD2 = 475,
  ERROR_DYNAMIC_TYPE_MISMATCH2 = 476,
  ERROR_PARENT_INDEX_PARTITION_REQUESTED = 477,
  ERROR_FIELD_SPACE_HAS_NO_FIELD = 478,
  ERROR_DYNAMIC_TYPE_MISMATCH3 = 479,
  ERROR_PARENT_LOGICAL_PARTITION_REQUESTED = 480,
  ERROR_INVALID_REQUEST_FOR_INDEXSPACE = 481,
  ERROR_UNABLE_FIND_ENTRY = 482,
  ERROR_UNABLE_FIND_ENTRY2 = 483,
  ERROR_INVALID_REQUEST_INDEXPARTITION = 484,
  ERROR_UNABLE_FIND_ENTRY3 = 485,
  ERROR_UNABLE_FIND_ENTRY4 = 486,
  ERROR_INVALID_REQUEST_FIELDSPACE = 487,
  ERROR_UNABLE_FIND_ENTRY5 = 488,
  ERROR_UNABLE_FIND_ENTRY6 = 489,
  ERROR_INVALID_REQUEST_LOGICALREGION = 490,
  ERROR_UNABLE_FIND_ENTRY7 = 491,
  ERROR_INVALID_REQUEST_LOGICALPARTITION = 492,
  ERROR_INVALID_REQUEST_TREE_ID = 493,
  ERROR_UNABLE_FIND_ENTRY8 = 494,
  ERROR_UNABLE_FIND_TOPLEVEL_TREE = 495,
  ERROR_UNABLE_FIND_ENTRY9 = 496,
  ERROR_INCONSISTENT_SEMANTIC_TAG2 = 497,
  ERROR_INCONSISTENT_SEMANTIC_TAG3 = 498,
  ERROR_INVALID_SEMANTIC_TAG2 = 499,
  ERROR_INVALID_SEMANTIC_TAG3 = 500,
  ERROR_UNABLE_FIND_ENTRY10 = 501,
  ERROR_ILLEGAL_DUPLICATE_REQUEST_ALLOCATOR = 502,
  ERROR_INCONSISTENT_SEMANTIC_TAG4 = 503,
  ERROR_INCONSISTENT_SEMANTIC_TAG5 = 504,
  ERROR_INCONSISTENT_SEMANTIC_TAG6 = 505,
  ERROR_INCONSISTENT_SEMANTIC_TAG7 = 506,
  ERROR_INCONSISTENT_SEMANTIC_TAG8 = 507,
  ERROR_INVALID_SEMANTIC_TAG4 = 508,
  ERROR_INVALID_SEMANTIC_TAG5 = 509,
  ERROR_ILLEGAL_DUPLICATE_FIELD_ID = 510,
  ERROR_EXCEEDED_MAXIMUM_NUMBER_ALLOCATED_FIELDS = 511,
  ERROR_ILLEGAL_DUPLICATE_FIELD_ID2 = 512,
  ERROR_EXCEEDED_MAXIMUM_NUMBER_ALLOCATED_FIELDS2 = 513,
  ERROR_ILLEGAL_DUPLICATE_FIELD_ID3 = 514,
  ERROR_INCONSISTENT_SEMANTIC_TAG10 = 515,
  ERROR_INCONSISTENT_SEMANTIC_TAG11 = 516,
  ERROR_INVALID_SEMANTIC_TAG6 = 517,
  ERROR_INVALID_SEMANTIC_TAG7 = 518,
  ERROR_USE_REDUCTION_REGION_REQ2 = 519,
  ERROR_USE_REDUCTION_REGION_REQ3 = 520,
  ERROR_RESERVED_REDOP_ID2 = 521,
  ERROR_RESERVED_REDOP_ID3 = 522,
  ERROR_USE_REDUCTION_REGION_REQ4 = 523,
  ERROR_USE_REDUCTION_REGION_REQ5 = 524,
  ERROR_USE_REDUCTION_REGION_REQ6 = 525,
  ERROR_RESERVED_REDOP_ID4 = 526,
  ERROR_RESERVED_REDOP_ID5 = 527,
  ERROR_RESERVED_REDOP_ID6 = 528,
  ERROR_REQUEST_FOR_EMPTY_FUTURE2 = 529,
  ERROR_UNKNOWN_MAPPABLE2 = 530,
  ERROR_DEPRECATED_PROJECTION2 = 531,
  ERROR_PARENT_TASK_INLINE6 = 532,
  ERROR_ILLEGAL_NOT_PREDICATE_CREATION = 533,
  ERROR_ILLEGAL_LEGION_BEGIN_STATIC_TRACE2 = 534,
  ERROR_COPY_SOURCE_REQUIREMENTS2 = 535,
  ERROR_PARENT_TASK_COPY6 = 536,
  ERROR_COPY_SOURCE_REQUIREMENT2 = 537,
  ERROR_COPY_DESTINATION_REQUIREMENT4 = 538,
  ERROR_INDEX_SPACE_COPY3 = 539,
  ERROR_MAPPER_FAILED_ACQUIRE2 = 540,
  ERROR_INVALID_MAPPER_REQUEST4 = 541,
  ERROR_INCONSISTENT_SEMANTIC_TAG9 = 542,
  ERROR_ACCESSING_EMPTY_FUTURE2 = 543,
  ERROR_INNER_TASK_VIOLATION2 = 544,
  ERROR_INNER_TASK_VIOLATION3 = 545,
  ERROR_ILLEGAL_IMPLICIT_MAPPING2 = 546,
  ERROR_ILLEGAL_IMPLICIT_MAPPING3 = 547,
  ERROR_ACCESSOR_PRIVILEGE_CHECK2 = 548,
  ERROR_ACCESSOR_PRIVILEGE_CHECK3 = 549,
  ERROR_ACCESSOR_PRIVILEGE_CHECK4 = 550,
  ERROR_ACCESSOR_PRIVILEGE_CHECK5 = 551,
  ERROR_ACCESSOR_PRIVILEGE_CHECK6 = 552,
  ERROR_INVALID_FIELD_PRIVILEGES2 = 553,
  ERROR_ACCESSOR_BOUNDS_CHECK2 = 554,
  ERROR_ACCESSOR_BOUNDS_CHECK3 = 555,
  ERROR_ACCESSOR_BOUNDS_CHECK4 = 556,
  ERROR_INCONSISTENT_SEMANTIC_TAG12 = 557,
  ERROR_INCONSISTENT_SEMANTIC_TAG13 = 558,
  ERROR_INVALID_SEMANTIC_TAG8 = 559,
  ERROR_INVALID_SEMANTIC_TAG9 = 560,
  ERROR_INVALID_PROJECTION_RESULT2 = 561,
  ERROR_INVALID_PROJECTION_RESULT3 = 562,
  ERROR_INVALID_PROJECTION_RESULT4 = 563,
  ERROR_INVALID_PROJECTION_RESULT5 = 564,
  ERROR_INVALID_PROJECTION_RESULT6 = 565,
  ERROR_INVALID_PROJECTION_RESULT7 = 566,
  ERROR_INVALID_PROJECTION_RESULT8 = 567,
  ERROR_INVALID_PROJECTION_RESULT9 = 568,
  ERROR_INVALID_PROJECTION_RESULT10 = 569,
  ERROR_INVALID_PROJECTION_RESULT11 = 570,
  ERROR_INVALID_PROJECTION_RESULT12 = 571,
  ERROR_MPI_INTEROPERABILITY_NOT_CONFIGURED2 = 572,
  ERROR_MPI_INTEROPERABILITY_NOT_CONFIGURED3 = 573,
  ERROR_STATIC_CALL_POST_RUNTIME_START2 = 574,
  ERROR_STATIC_CALL_POST_RUNTIME_START3 = 575,
  ERROR_STATIC_CALL_POST_RUNTIME_START4 = 576,
  ERROR_STATIC_CALL_POST_RUNTIME_START5 = 577,
  ERROR_STATIC_CALL_POST_RUNTIME_START6 = 578,
  ERROR_STATIC_CALL_POST_RUNTIME_START7 = 579,
  ERROR_RESERVED_PROJECTION_ID2 = 580,
  ERROR_DUPLICATE_PROJECTION_ID2 = 581,
  ERROR_INVALID_TARGET_PROC2 = 582,
  ERROR_RESERVED_REDOP_ID7 = 583,
  ERROR_MAX_APPLICATION_TASK_ID_EXCEEDED2 = 584,
  ERROR_NO_PROCESSORS2 = 585,
  ...
  LEGION_WARNING_MAPPER_FAILED_ACQUIRE2 = 1018,
  ...
  LEGION_WARNING_MAPPER_FAILED_ACQUIRE3 = 1025,
  ...
  LEGION_WARNING_MAPPER_FAILED_ACQUIRE5 = 1029,
  ...
  LEGION_WARNING_MAPPER_REQUESTED_INLINE2 = 1033,
  LEGION_WARNING_REGION_REQUIREMENTS_INDEX2 = 1034,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST = 1035,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST2 = 1036,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST3 = 1037,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST4 = 1038,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST5 = 1039,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST6 = 1040,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST7 = 1041,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST8 = 1042,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST9 = 1043,
  LEGION_WARNING_IGNORING_RELEASE_REQUEST = 1044,
  LEGION_WARNING_IGNORING_RELEASE_REQUEST2 = 1045,
  LEGION_WARNING_IGNORING_RELEASE_REQUEST3 = 1046,
  LEGION_WARNING_WAITING_FUTURE_NONLEAF = 1047,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST10 = 1048,
  LEGION_WARNING_IGNORING_ACQUIRE_REQUEST11 = 1049,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING = 1050,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING2 = 1051,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING3 = 1052,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING4 = 1053,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING5 = 1054,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING6 = 1055,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING7 = 1056,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING8 = 1057,
  LEGION_WARNING_IGNORING_EMPTY_INDEX_TASK_LAUNCH = 1058,
  LEGION_WARNING_IGNORING_EMPTY_INDEX_TASK_LAUNCH2 = 1059,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING9 = 1060,
  LEGION_WARNING_IGNORING_EMPTY_INDEX_SPACE_FILL = 1061,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING10 = 1062,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING11 = 1063,
  LEGION_WARNING_IGNORING_EMPTY_INDEX_SPACE_COPY = 1064,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING12 = 1065,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING13 = 1066,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING14 = 1067,
  LEGION_WARNING_RUNTIME_UNMAPPING_REMAPPING15 = 1068,
  LEGION_WARNING_VARIANT_TASK_NOT_MARKED = 1069,
  LEGION_WARNING_VARIANT_TASK_NOT_MARKED2 = 1070,
  LEGION_WARNING_REGION_REQUIREMENT_OPERATION_USING = 1071,
  LEGION_WARNING_NEW_PROJECTION_FUNCTORS2 = 1072,
  LEGION_WARNING_MAPPER_FAILED_ACQUIRE4 = 1073,
  LEGION_WARNING_MAPPER_REQUESTED_POST = 1074,
  LEGION_WARNING_MAPPER_REQUESTED_POST2 = 1075,
  LEGION_WARNING_MAPPER_REQUESTED_POST3 = 1076,
  LEGION_WARNING_WAITING_REGION2 = 1077,
  LEGION_WARNING_NONLEAF_ACCESSOR2 = 1078,
  LEGION_WARNING_NONLEAF_ACCESSOR3 = 1079,
  LEGION_WARNING_UNMAPPED_ACCESSOR2 = 1080,
  LEGION_WARNING_UNMAPPED_ACCESSOR3 = 1081,
  ...
  LEGION_FATAL_DEFAULT_MAPPER_ERROR2 = 2003,
  LEGION_FATAL_DEFAULT_MAPPER_ERROR3 = 2004,
  LEGION_FATAL_MUST_EPOCH_NOADDRESS2 = 2005,
