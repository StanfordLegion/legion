...
typedef enum legion_error_t {
  ...
  ERROR_EXCEEDED_MAX_APPLICATION_COLOR = 570,
  ...
  LEGION_WARNING_DYNAMIC_SHARDING_REG = 1104,
  LEGION_WARNING_SLOW_NON_FUNCTIONAL_PROJECTION = 1105,
  LEGION_WARNING_MISMATCHED_REPLICATED_FUTURES = 1106,
  LEGION_WARNING_INLINING_NOT_SUPPORTED = 1107,
