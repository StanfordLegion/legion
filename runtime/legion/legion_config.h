...
typedef enum legion_error_t {
  ...
  ERROR_ILLEGAL_PARTIAL_ACQUISITION = 153,
  ERROR_ILLEGAL_INTERFERING_RESTRICTIONS = 154,
  ERROR_ILLEGAL_PARTIAL_RESTRICTION = 155,
  ERROR_ILLEGAL_INTERFERING_ACQUISITIONS = 156,
  ERROR_UNRESTRICTED_ACQUIRE = 157,
  ERROR_UNACQUIRED_RELEASE = 158,
  ERROR_UNATTACHED_DETACH = 159,
  ERROR_ILLEGAL_PARTIAL_RESTRICTION_REQUEST = 160,
}  legion_error_t;
