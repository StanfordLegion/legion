...
typedef enum legion_error_t {
  ...
  LEGION_WARNING_DYNAMIC_SHARDING_REG = 1102,
  LEGION_WARNING_SLOW_NON_FUNCTIONAL_PROJECTION = 1103,
  LEGION_WARNING_MISSING_MUST_EPOCH_DOMAIN = 1104,
  LEGION_WARNING_MISMATCHED_REPLICATED_FUTURES = 1105,
...
typedef enum legion_type_id_t {
  ...
  LEGION_TYPE_INT32 = 2,
  LEGION_TYPE_INT64 = 3,
  LEGION_TYPE_UINT16 = 4,
  LEGION_TYPE_UINT32 = 5,
  LEGION_TYPE_UINT64 = 6,
  LEGION_TYPE_FLOAT16 = 7,
  LEGION_TYPE_FLOAT32 = 8,
