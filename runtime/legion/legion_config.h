...
typedef enum legion_coherence_property_t {
  ...
  LEGION_COLLECTIVE_EXCLUSIVE = LEGION_EXCLUSIVE | LEGION_COLLECTIVE_MASK,
  LEGION_COLLECTIVE_ATOMIC = LEGION_ATOMIC | LEGION_COLLECTIVE_MASK,
  LEGION_COLLECTIVE_SIMULTANEOUS = LEGION_SIMULTANEOUS | LEGION_COLLECTIVE_MASK,
  LEGION_COLLECTIVE_RELAXED = LEGION_RELAXED | LEGION_COLLECTIVE_MASK,
  // for backwards compatibility
