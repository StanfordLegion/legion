...
typedef enum legion_error_t {
  ...
  ERROR_MAPPER_COLLECTIVE_INSTANCE_MISMATCH = 619,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_SYNC_MODEL = 620,  
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NON_POINT = 621,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_BAD_POINT = 622,
