...
typedef enum legion_error_t {
  ...
  LEGION_WARNING_DYNAMIC_SHARDING_REG = 1096,
  LEGION_WARNING_SLOW_NON_FUNCTIONAL_PROJECTION = 1097,
  LEGION_WARNING_MAPPER_INVALID_INSTANCE = 1098,
  LEGION_WARNING_MISSING_MUST_EPOCH_DOMAIN = 1099,
  LEGION_WARNING_MISMATCHED_REPLICATED_FUTURES = 1100,
  LEGION_WARNING_EAGER_PROJECTION_EVALUATION = 1101,
