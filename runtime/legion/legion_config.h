...
typedef enum legion_error_t {
  ...
  ERROR_MAPPER_COLLECTIVE_INSTANCE_MISMATCH = 623,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_SYNC_MODEL = 624,  
  ERROR_MAPPER_COLLECTIVE_INSTANCE_NON_POINT = 625,
  ERROR_MAPPER_COLLECTIVE_INSTANCE_BAD_POINT = 626,
