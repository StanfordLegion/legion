...
namespace Legion {
  namespace Internal {
    ...
    {
      std::stringstream ss;
      ss << "FileType: BinaryLegionProf v: " << LEGION_PROF_VERSION
         << std::endl;
      ss << LEGION_VERSION << std::endl;
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(mapper_name.mapper_id), sizeof(mapper_name.mapper_id));
      lp_fwrite(
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(mapper_call_desc.kind), sizeof(mapper_call_desc.kind));
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(runtime_call_desc.kind), sizeof(runtime_call_desc.kind));
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(meta_desc.ordered_vc), sizeof(meta_desc.ordered_vc));
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(max_dim_desc.max_dim), sizeof(max_dim_desc.max_dim));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(machine_desc.node_id), sizeof(machine_desc.node_id));
      lp_fwrite(
          f, (char*)&(machine_desc.num_nodes), sizeof(machine_desc.num_nodes));
      lp_fwrite(
          f, machine_desc.process_info.hostname,
          strlen(machine_desc.process_info.hostname) + 1);
      lp_fwrite(
          f, (char*)&(machine_desc.process_info.hostid),
          sizeof(machine_desc.process_info.hostid));
      lp_fwrite(
          f, (char*)&(machine_desc.process_info.processid),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(calibration_err.calibration_err),
    ...
    //--------------------------------------------------------------------------
    {
      int ID = ZERO_TIME_ID;
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(f, (char*)&(zero_time.zero_time), sizeof(zero_time.zero_time));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(ispace_point_desc.unique_id),
          sizeof(ispace_point_desc.unique_id));
      lp_fwrite(
          f, (char*)&(ispace_point_desc.dim), sizeof(ispace_point_desc.dim));
#define DIMFUNC(DIM)                                  \
  lp_fwrite(                                          \
      f, (char*)&(ispace_point_desc.points[DIM - 1]), \
...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(ispace_rect_desc.unique_id),
          sizeof(ispace_rect_desc.unique_id));
      lp_fwrite(
          f, (char*)&(ispace_rect_desc.dim), sizeof(ispace_rect_desc.dim));
#define DIMFUNC(DIM)                                  \
  lp_fwrite(                                          \
      f, (char*)&(ispace_rect_desc.rect_lo[DIM - 1]), \
      sizeof(ispace_rect_desc.rect_lo[DIM - 1]));
      LEGION_FOREACH_N(DIMFUNC)
#undef DIMFUNC
#define DIMFUNC(DIM)                                  \
  lp_fwrite(                                          \
      f, (char*)&(ispace_rect_desc.rect_hi[DIM - 1]), \
...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(ispace_empty_desc.unique_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(field_desc.unique_id), sizeof(field_desc.unique_id));
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(field_space_desc.unique_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(index_subspace_desc.parent_id),
          sizeof(index_subspace_desc.parent_id));
      lp_fwrite(
          f, (char*)&(index_subspace_desc.unique_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(index_part_desc.parent_id),
          sizeof(index_part_desc.parent_id));
      lp_fwrite(
          f, (char*)&(index_part_desc.unique_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(phy_instance_rdesc.inst_uid.id),
          sizeof(phy_instance_rdesc.inst_uid.id));
      lp_fwrite(
          f, (char*)&(phy_instance_rdesc.ispace_id),
          sizeof(phy_instance_rdesc.ispace_id));
      lp_fwrite(
          f, (char*)&(phy_instance_rdesc.fspace_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(phy_instance_dim_order_rdesc.inst_uid.id),
          sizeof(phy_instance_dim_order_rdesc.inst_uid.id));
      lp_fwrite(
          f, (char*)&(phy_instance_dim_order_rdesc.dim), sizeof(unsigned));
      lp_fwrite(f, (char*)&(phy_instance_dim_order_rdesc.k), sizeof(unsigned));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(phy_instance_layout_rdesc.inst_uid.id),
          sizeof(phy_instance_layout_rdesc.inst_uid.id));
      lp_fwrite(
          f, (char*)&(phy_instance_layout_rdesc.field_id),
          sizeof(phy_instance_layout_rdesc.field_id));
      lp_fwrite(
          f, (char*)&(phy_instance_layout_rdesc.fspace_id),
          sizeof(phy_instance_layout_rdesc.fspace_id));
      lp_fwrite(f, (char*)&(phy_instance_layout_rdesc.has_align), sizeof(bool));
      lp_fwrite(f, (char*)&(phy_instance_layout_rdesc.eqk), sizeof(unsigned));
      lp_fwrite(
          f, (char*)&(phy_instance_layout_rdesc.alignment), sizeof(unsigned));
    }
    ...
    //--------------------------------------------------------------------------
    void LegionProfBinarySerializer::serialize(
        const LegionProfInstance::IndexSpaceSizeDesc& size_desc)
    //--------------------------------------------------------------------------
    {
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(task_variant.task_id), sizeof(task_variant.task_id));
      lp_fwrite(
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(operation_instance.op_id),
          sizeof(operation_instance.op_id));
      lp_fwrite(
          f, (char*)&(operation_instance.parent_id),
          sizeof(operation_instance.parent_id));
      lp_fwrite(
          f, (char*)&(operation_instance.kind),
          sizeof(operation_instance.kind));
      lp_fwrite(
          f, (char*)&(operation_instance.provenance),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(slice_owner.parent_id), sizeof(slice_owner.parent_id));
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(task_info.variant_id), sizeof(task_info.variant_id));
      lp_fwrite(
          f, (char*)&(wait_info.wait_start), sizeof(wait_info.wait_start));
      lp_fwrite(
          f, (char*)&(wait_info.wait_ready), sizeof(wait_info.wait_ready));
      lp_fwrite(f, (char*)&(wait_info.wait_end), sizeof(wait_info.wait_end));
      lp_fwrite(
          f, (char*)&(wait_info.wait_event), sizeof(wait_info.wait_event));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(task_info.finish_event), sizeof(task_info.finish_event));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(meta_info.finish_event), sizeof(meta_info.finish_event));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(copy_inst.src_inst_uid.id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(
          f, (char*)&(fill_inst.dst_inst_uid.id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.inst_uid.id),
          sizeof(inst_timeline_info.inst_uid.id));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.inst_id),
          sizeof(inst_timeline_info.inst_id));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.mem_id),
          sizeof(inst_timeline_info.mem_id));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.size),
          sizeof(inst_timeline_info.size));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.op_id),
          sizeof(inst_timeline_info.op_id));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.create),
          sizeof(inst_timeline_info.create));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.ready),
          sizeof(inst_timeline_info.ready));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.destroy),
          sizeof(inst_timeline_info.destroy));
      lp_fwrite(
          f, (char*)&(inst_timeline_info.creator),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(partition_info.op_id), sizeof(partition_info.op_id));
      lp_fwrite(
          f, (char*)&(partition_info.part_op), sizeof(partition_info.part_op));
      lp_fwrite(
          f, (char*)&(partition_info.create), sizeof(partition_info.create));
      lp_fwrite(
          f, (char*)&(partition_info.ready), sizeof(partition_info.ready));
      lp_fwrite(
          f, (char*)&(partition_info.start), sizeof(partition_info.start));
      lp_fwrite(f, (char*)&(partition_info.stop), sizeof(partition_info.stop));
      lp_fwrite(
          f, (char*)&(partition_info.creator), sizeof(partition_info.creator));
      lp_fwrite(
          f, (char*)&(partition_info.critical),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(mapper_call_info.mapper),
          sizeof(mapper_call_info.mapper));
      lp_fwrite(
          f, (char*)&(mapper_call_info.mapper_proc),
          sizeof(mapper_call_info.mapper_proc));
      lp_fwrite(
          f, (char*)&(mapper_call_info.kind), sizeof(mapper_call_info.kind));
      lp_fwrite(
          f, (char*)&(mapper_call_info.op_id), sizeof(mapper_call_info.op_id));
      lp_fwrite(
          f, (char*)&(mapper_call_info.start), sizeof(mapper_call_info.start));
      lp_fwrite(
          f, (char*)&(mapper_call_info.stop), sizeof(mapper_call_info.stop));
      lp_fwrite(
          f, (char*)&(mapper_call_info.proc_id),
          sizeof(mapper_call_info.proc_id));
      lp_fwrite(
          f, (char*)&(mapper_call_info.finish_event),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(runtime_call_info.kind), sizeof(runtime_call_info.kind));
      lp_fwrite(
          f, (char*)&(runtime_call_info.start),
          sizeof(runtime_call_info.start));
      lp_fwrite(
          f, (char*)&(runtime_call_info.stop), sizeof(runtime_call_info.stop));
      lp_fwrite(
          f, (char*)&(runtime_call_info.proc_id),
          sizeof(runtime_call_info.proc_id));
      lp_fwrite(
          f, (char*)&(runtime_call_info.finish_event),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(application_call_info.pid),
          sizeof(application_call_info.pid));
      lp_fwrite(
          f, (char*)&(application_call_info.start),
          sizeof(application_call_info.start));
      lp_fwrite(
          f, (char*)&(application_call_info.stop),
          sizeof(application_call_info.stop));
      lp_fwrite(
          f, (char*)&(application_call_info.proc_id),
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
        lp_fwrite(f, (char*)&(proc_desc.cuda_device_uuid[i]), sizeof(char));
      }
#else
      ...
      {
        lp_fwrite(f, (char*)&(uuid_str[i]), sizeof(char));
      }
#endif
    }
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    {
      ...
      lp_fwrite(f, (char*)&ID, sizeof(ID));
      lp_fwrite(
          f, (char*)&(proftask_info.proc_id), sizeof(proftask_info.proc_id));
      ...
      lp_fwrite(
          f, (char*)&(proftask_info.creator), sizeof(proftask_info.creator));
      lp_fwrite(
          f, (char*)&(proftask_info.finish_event),
          sizeof(proftask_info.finish_event));
      lp_fwrite(
          f, (char*)&(proftask_info.completion),
    ...
    //--------------------------------------------------------------------------
    {
#if LEGION_MAX_DIM == 1
      log_prof.print(
          "Index Space Point Desc  %llu %d %lld", ispace_point_desc.unique_id,
          ispace_point_desc.dim, (long long)ispace_point_desc.points[0]);
#elif LEGION_MAX_DIM == 2
      log_prof.print(
          "Index Space Point Desc  %llu %d %lld %lld",
          ispace_point_desc.unique_id, ispace_point_desc.dim,
          (long long)ispace_point_desc.points[0],
          (long long)ispace_point_desc.points[1]);
#elif LEGION_MAX_DIM == 3
      log_prof.print(
          "Index Space Point Desc  %llu %d %lld %lld %lld",
          ispace_point_desc.unique_id, ispace_point_desc.dim,
          (long long)ispace_point_desc.points[0],
          (long long)ispace_point_desc.points[1],
      ...
      log_prof.print(
          "Index Space Point Desc  %llu %d %lld %lld %lld %lld",
          ispace_point_desc.unique_id, ispace_point_desc.dim,
          (long long)ispace_point_desc.points[0],
          (long long)ispace_point_desc.points[1],
          (long long)ispace_point_desc.points[2],
      ...
      log_prof.print(
          "Index Space Point Desc  %llu %d %lld %lld %lld %lld %lld "
          "%lld %lld %lld %lld",
          ispace_point_desc.unique_id, ispace_point_desc.dim,
          (long long)ispace_point_desc.points[0],
          (long long)ispace_point_desc.points[1],
...
#error "Illegal LEGION_MAX_DIM"
    ...
    {
      log_prof.print(
          "Index Space Empty Desc %llu", ispace_empty_desc.unique_id);
    }
...
#if LEGION_MAX_DIM == 1
      log_prof.print(
          "Index Space Rect Desc %llu %d %lld "
          "%lld",
          ispace_rect_desc.unique_id, ispace_rect_desc.dim,
          (long long)(ispace_rect_desc.rect_lo[0]),
          (long long)(ispace_rect_desc.rect_hi[0]), );
#elif LEGION_MAX_DIM == 2
      log_prof.print(
          "Index Space Rect Desc %llu %d %lld %lld %lld "
          "%lld",
          ispace_rect_desc.unique_id, ispace_rect_desc.dim,
          (long long)(ispace_rect_desc.rect_lo[0]),
...
#elif LEGION_MAX_DIM == 3
      log_prof.print(
          "Index Space Rect Desc %llu %d %lld %lld %lld %lld "
          "%lld %lld",
          ispace_rect_desc.unique_id, ispace_rect_desc.dim,
          (long long)(ispace_rect_desc.rect_lo[0]),
          (long long)(ispace_rect_desc.rect_lo[1]),
...
#elif LEGION_MAX_DIM == 6
      log_prof.print(
          "Index Space Rect Desc %llu %d %lld %lld %lld %lld %lld "
...
#error "Illegal LEGION_MAX_DIM"
    ...
    {
      log_prof.print(
          "Field Name Desc %llu %u %llu %s", field_desc.unique_id,
          field_desc.field_id, field_desc.size, field_desc.name);
    }
    ...
    {
      log_prof.print(
          "Field Space Name Desc %llu %s", field_space_desc.unique_id,
    ...
    {
      log_prof.print(
          "Index Part Name Desc %llu %s", index_part_desc.unique_id,
    ...
    {
      log_prof.print(
          "Index Space Name Desc %llu %s", index_space_desc.unique_id,
    ...
    {
      log_prof.print(
          "Index Sub Space Desc %llu %llu", index_subspace_desc.parent_id,
    ...
    {
      log_prof.print(
          "Index Partition Desc %llu %llu %d %llu", index_part_desc.parent_id,
          index_part_desc.unique_id, index_part_desc.disjoint,
    ...
    {
      log_prof.print(
          "Logical Region Desc %llu %llu %u %s", lr_desc.ispace_id,
          lr_desc.fspace_id, lr_desc.tree_id, lr_desc.name);
    }
    ...
    {
      log_prof.print(
          "Physical Inst Region Desc " IDFMT " %llu %llu %u",
          phy_instance_rdesc.inst_uid.id, phy_instance_rdesc.ispace_id,
          phy_instance_rdesc.fspace_id, phy_instance_rdesc.tree_id);
    }
    ...
    {
      log_prof.print(
          "Physical Inst Dim Order Desc " IDFMT " %u %u",
          phy_instance_dim_order_rdesc.inst_uid.id,
          phy_instance_dim_order_rdesc.dim, phy_instance_dim_order_rdesc.k);
    }
    ...
    {
      log_prof.print(
          "Index Space Size Desc "
          "%llu %llu %llu %u",
          size_desc.id, size_desc.dense_size, size_desc.sparse_size,
          size_desc.is_sparse);
    }
    ...
    {
      log_prof.print(
          "Prof Mapper Call Desc %u %s", mapper_call_desc.kind,
          mapper_call_desc.name);
    }
    ...
    {
      log_prof.print(
          "Prof Runtime Call Desc %u %s", runtime_call_desc.kind,
          runtime_call_desc.name);
    }
    ...
    {
      log_prof.print(
          "Prof Meta Desc %u %d %d %s", meta_desc.kind,
          meta_desc.message ? 1 : 0, meta_desc.ordered_vc ? 1 : 0,
          meta_desc.name);
    }
    ...
    {
      log_prof.print(
          "Runtime Config %d %d %d %d %d %d %d %d %d %d", config.debug ? 1 : 0,
          config.spy ? 1 : 0, config.gc ? 1 : 0, config.inorder ? 1 : 0,
          config.safe_mapper ? 1 : 0, config.safe_runtime ? 1 : 0,
          config.safe_ctrlrepl ? 1 : 0, config.part_checks ? 1 : 0,
          config.bounds_checks ? 1 : 0, config.resilient ? 1 : 0);
    }
    ...
    {
      log_prof.print(
          "Machine Desc %d %d %s %llu %d", machine_desc.node_id,
          machine_desc.num_nodes, machine_desc.process_info.hostname,
    ...
    {
      log_prof.print(
          "Prof Operation %llu %llu %u %lld", op_inst.op_id, op_inst.parent_id,
          op_inst.kind, op_inst.provenance);
    }
    ...
    {
      log_prof.print(
          "Prof Multi %llu %u", multi_task.op_id, multi_task.task_id);
    }
    ...
    {
      log_prof.print(
          "Prof Slice Owner %llu %llu", slice_owner.parent_id,
          slice_owner.op_id);
    }
    ...
    {
      log_prof.print(
          "Prof Task Wait Info %llu %u %u %llu %llu %llu " IDFMT,
    ...
    {
      log_prof.print(
          "Prof Meta Wait Info %llu %u %llu %llu %llu " IDFMT, meta_info.op_id,
          meta_info.lg_id, wait_info.wait_start, wait_info.wait_ready,
    ...
    //--------------------------------------------------------------------------
    {
      if (implicit)
        log_prof.print(
            "Prof Implicit Task Info %llu %u %u " IDFMT
            " %llu %llu "
    ...
    {
      log_prof.print(
          "Prof GPU Task Info %llu %u %u " IDFMT
          " %llu %llu %llu "
          "%llu %llu %llu " IDFMT " " IDFMT " " IDFMT "",
          task_info.op_id, task_info.task_id, task_info.variant_id,
          task_info.proc_id, task_info.create, task_info.ready, task_info.start,
          task_info.stop, task_info.gpu_start, task_info.gpu_stop,
          task_info.creator.id, task_info.critical.id,
    ...
    {
      log_prof.print(
          "Prof Meta Info %llu %u " IDFMT " %llu %llu %llu %llu " IDFMT
          " " IDFMT " " IDFMT "",
          meta_info.op_id, meta_info.lg_id, meta_info.proc_id, meta_info.create,
          meta_info.ready, meta_info.start, meta_info.stop,
    ...
    {
      log_prof.print(
          "Prof Fill Inst Info " IDFMT " %d " IDFMT " " IDFMT, fill_inst.dst,
          fill_inst.fid, fill_inst.dst_inst_uid.id, fill_info.fevent.id);
    }
    ...
    {
      log_prof.print(
          "Prof Inst Timeline " IDFMT " " IDFMT " " IDFMT
          " %llu %llu %llu %llu %llu",
    ...
    {
      log_prof.print(
          "Prof Partition Timeline %llu %d %llu %llu %llu %llu %llu " IDFMT
          " " IDFMT "",
          partition_info.op_id, partition_info.part_op, partition_info.create,
    ...
    {
      log_prof.print(
          "Prof Mapper Call Info %u " IDFMT " %u " IDFMT
          " %llu %llu %llu " IDFMT,
          mapper_call_info.mapper, mapper_call_info.proc_id,
          mapper_call_info.kind, mapper_call_info.proc_id,
          mapper_call_info.op_id, mapper_call_info.start, mapper_call_info.stop,
    ...
    {
      log_prof.print(
          "Prof Runtime Call Info %u " IDFMT " %llu %llu " IDFMT,
    ...
    {
      log_prof.print(
          "Prof Application Call Info %llu " IDFMT " %llu %llu " IDFMT,
    ...
    {
      log_prof.print(
          "Prof Proc Desc " IDFMT " %d", proc_desc.proc_id, proc_desc.kind);
#ifdef LEGION_USE_CUDA
    ...
    {
      log_prof.print(
          "Prof Mem Desc " IDFMT " %d %llu", mem_desc.mem_id, mem_desc.kind,
          mem_desc.capacity);
    }
    ...
    {
      log_prof.print(
          "Prof Mem Proc Affinity Desc " IDFMT " " IDFMT " %u %u", pm.proc_id,
          pm.mem_id, pm.bandwidth, pm.latency);
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
        log_prof.print(
            "Prof Event Merger Info " IDFMT " " IDFMT " %llu " IDFMT " " IDFMT
            " " IDFMT " " IDFMT,
            info.result.id, info.fevent.id, info.performed,
            info.preconditions[offset].id,
            (offset + 1) < info.preconditions.size() ?
                info.preconditions[offset + 1].id :
                0,
            (offset + 2) < info.preconditions.size() ?
                info.preconditions[offset + 2].id :
                0,
    ...
    {
      log_prof.print(
          "Prof Event Trigger Info " IDFMT " " IDFMT " " IDFMT " %lld",
          info.result.id, info.fevent.id, info.precondition.id, info.performed);
    }
    ...
    {
      log_prof.print(
          "Prof Event Poison Info " IDFMT " " IDFMT " %lld", info.result.id,
          info.fevent.id, info.performed);
    }
    ...
    {
      log_prof.print(
          "Prof Barrier Arrival Info " IDFMT " " IDFMT " " IDFMT " %lld",
          info.result.id, info.fevent.id, info.precondition.id, info.performed);
    }
    ...
    {
      log_prof.print(
          "Prof Reservation Acquire Info " IDFMT " " IDFMT " " IDFMT
          " %lld " IDFMT,
          info.result.id, info.fevent.id, info.precondition.id, info.performed,
          info.reservation.id);
    }
    ...
    {
      log_prof.print(
          "Prof Instance Ready Info " IDFMT " " IDFMT " " IDFMT " %lld",
          info.result.id, info.precondition.id, info.unique.id, info.performed);
    }
    ...
    {
      log_prof.print(
          "Prof Instance Redistrict Info " IDFMT " " IDFMT " " IDFMT " " IDFMT
          " %lld",
          info.result.id, info.precondition.id, info.previous.id, info.next.id,
          info.performed);
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
        log_prof.print(
            "Prof Completion Queue Info " IDFMT " " IDFMT " %llu " IDFMT
            " " IDFMT " " IDFMT " " IDFMT,
            info.result.id, info.fevent.id, info.performed,
            info.preconditions[offset].id,
            (offset + 1) < info.preconditions.size() ?
    ...
    {
      log_prof.print(
          "Prof ProfTask Info " IDFMT " %llu %llu %llu " IDFMT " " IDFMT " %d",
          proftask_info.proc_id, proftask_info.op_id, proftask_info.start,
          proftask_info.stop, proftask_info.creator.id,
          proftask_info.finish_event.id, proftask_info.completion ? 1 : 0);
    }
