...
#undef MEM_NAMES
...
#endif
            find_event(precondition), src_unique, dst_unique, priority));
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      IssueAcross *across = new IssueAcross(*this, lhs_, copy_pre,
          collective_pre, src_indirect_pre, dst_indirect_pre,
          find_trace_local_id(memo), executor);
