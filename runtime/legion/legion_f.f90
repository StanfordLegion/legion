module legion_fortran
  ...
  subroutine legion_index_partition_attach_name_f(runtime, handle, name, is_mutable) 
    ...
    character(len=*), target, intent(in)         :: name
    logical, intent(in)                          :: is_mutable
  
    call legion_index_partition_attach_name_c(runtime, handle, c_loc(name), logical(is_mutable, kind=c_bool)) 
  ...
  subroutine legion_logical_partition_attach_name_f(runtime, handle, name, is_mutable)
    ...
    call legion_logical_partition_attach_name_c(runtime, handle, c_loc(name), logical(is_mutable, kind=c_bool))
