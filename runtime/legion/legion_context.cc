...
namespace Legion {
  namespace Internal {
    ...
    //--------------------------------------------------------------------------
    {
      ...
      else
      {
        ...
        if (!unmapped_regions.empty())
        {
          ...
          {
             if (index) {
               LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING(1200, "undefined");
              log_run.warning(RUNTIME_UNMAPPING_REMAPPING.id(),
                ...
                LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING2(1201, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         LegionInternal::Logger::MessageDescriptor ILLEGAL_RUNTIME_REMAPPING(1202, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (coloring.empty())
      {
         LegionInternal::Logger::MessageDescriptor ATTEMPT_CREATE_INDEX_PARTITION(1203, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (coloring.empty())
      {
         LegionInternal::Logger::MessageDescriptor ATTEMPT_CREATE_INDEX_PARTITION2(1204, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (coloring.empty())
      {
         LegionInternal::Logger::MessageDescriptor ATTEMPT_CREATE_INDEX_PARTITION3(1205, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (!unmapped_regions.empty())
      {
         if (Runtime::runtime_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING3(1206, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING4(1207, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING5(1208, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (local)
      {
        ...
        {
           LegionInternal::Logger::MessageDescriptor EXCEEDED_MAXIMUM_LOCAL_FIELDS(1209, "undefined");
        ...
        {
           LegionInternal::Logger::MessageDescriptor UNABLE_ALLOCATE_LOCAL_FIELD(1210, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (local)
      {
        ...
        {
           LegionInternal::Logger::MessageDescriptor EXCEEDED_MAXIMUM_LOCAL_FIELDS2(1211, "undefined");
        ...
        {
           LegionInternal::Logger::MessageDescriptor UNABLE_ALLOCATE_LOCAL_FIELD2(1212, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (launcher.predicate == Predicate::FALSE_PRED)
      {
        ...
        else
        {
          ...
          {
             LegionInternal::Logger::MessageDescriptor PREDICATED_TASK_NONVOID_RETURN(1213, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (launcher.predicate == Predicate::FALSE_PRED)
      {
        ...
        if (launcher.predicate_false_result.get_size() == 0)
        {
          ...
          if (impl->returns_value())
          {
             LegionInternal::Logger::MessageDescriptor PREDICATED_INDEX_TASK_NONVOID_RETURN(1214, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (launcher.predicate == Predicate::FALSE_PRED)
      {
        ...
        else
        {
          ...
          if (impl->returns_value())
          {
             LegionInternal::Logger::MessageDescriptor PREDICATED_INDEX_TASK_NONVOID_RETURN2(1215, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (parent_conflict)
      {
         LegionInternal::Logger::MessageDescriptor INLINE_MAPPING_CONFLICT_DEADLOCK(1216, "undefined");
      ...
      if (inline_conflict)
      {
         LegionInternal::Logger::MessageDescriptor INLINE_MAPPING_CONFLICT_DEADLOCK2(1217, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (!unmapped_regions.empty())
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_6(1218, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         LegionInternal::Logger::MessageDescriptor IGNORING_EMPTY_INDEX_FILL(1236, "undefined");
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_7(1219, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_8(1220, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (launcher.domain.get_volume() == 0)
      {
         LegionInternal::Logger::MessageDescriptor IGNORE_EMPTY_COPY(1221, "undefined");
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_9(1222, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_10(1223, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_11(1224, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (parent_conflict)
      {
         LegionInternal::Logger::MessageDescriptor ATTACH_HDF5_CONFLICT(1225, "undefined");
      ...
      if (inline_conflict)
      {
         LegionInternal::Logger::MessageDescriptor ATTACH_HDF5_CONFLICT2(1226, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         if (Runtime::runtime_warnings && !launcher.silence_warnings) {
            LegionInternal::Logger::MessageDescriptor RUNTIME_UNMAPPING_REMAPPING_12(1226, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (f.impl == NULL)
      {
         LegionInternal::Logger::MessageDescriptor ILLEGAL_PREDICATE_CREATION(1227, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         LegionInternal::Logger::MessageDescriptor ILLEGAL_PREDICATE_CREATION2(1228, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      if (!runtime->forest->add_acquisition(coherence_restrictions, op, req))
      {
        // We faiiled to acquire, report the error
         LegionInternal::Logger::MessageDescriptor ILLEGAL_ACQUIRE_OPERATION(1229, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      if (!runtime->forest->remove_acquisition(coherence_restrictions, op, req))
      {
        // We failed to release, report the error
         LegionInternal::Logger::MessageDescriptor ILLEGAL_RELEASE_OPERATION(1230, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      if (!runtime->forest->remove_restriction(coherence_restrictions, op, req))
      {
        // We failed to remove the restriction
         LegionInternal::Logger::MessageDescriptor ILLEGAL_DETACH_OPERATION(1231, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if ((context_configuration.min_tasks_to_schedule == 0) && 
          (context_configuration.min_frames_to_schedule == 0))
      {
         LegionInternal::Logger::MessageDescriptor ILLEGAL_MAPPER_OUTPUT(1232, "undefined");
      ...
      if (Runtime::runtime_warnings)
      {
        if (total_children_count == 0)
        {
          ...
          VariantImpl *impl = 
           ...
           LegionInternal::Logger::MessageDescriptor VARIANT_NOT_MARKED_AS_LEAF(1233, "undefined");
        ...
        else if (!single_task->is_inner())
        {
          ...
          if (!has_accessor)
          {
            VariantImpl *impl = 
              runtime->find_variant_impl(single_task->task_id, 
                                         single_task->get_selected_variant());
             LegionInternal::Logger::MessageDescriptor VARIANT_NOT_MARKED_AS_INNER(1234, "undefined");
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
         LegionInternal::Logger::MessageDescriptor INVALID_MAPPER_OUTPUT2(1235, "undefined");
