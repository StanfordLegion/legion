...
# The purpose of this script is to silence the warning when you
# connect to a new host via SSH.... without just disabling the check
# (that would be wildly insecure).
...
cat "$GITHUB_HOSTKEY" >> "$HOME/.ssh/authorized_keys"
