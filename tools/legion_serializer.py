...
class LegionProfASCIIDeserializer(LegionDeserializer):
    ...
    patterns = {
        "MapperName": re.compile(prefix + r'Prof Mapper Name (?P<mapper_id>[0-9]+) (?P<name>[a-zA-Z0-9_ ]+)'),
        ...
        "MapperCallInfo": re.compile(prefix + r'Prof Mapper Call Info (?P<mapper_id>[0-9]+) (?P<kind>[0-9]+) (?P<proc_id>[a-f0-9]+) (?P<op_id>[0-9]+) (?P<start>[0-9]+) (?P<stop>[0-9]+) (?P<fevent>[0-9a-f]+)'),
