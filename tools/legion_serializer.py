...
class LegionProfASCIIDeserializer(LegionDeserializer):
    ...
    patterns = {
        ...
        "PhysicalInstanceUsage": re.compile(prefix + r'Physical Inst Usage (?P<inst_id>[a-f0-9]+) (?P<op_id>[0-9]+) (?P<index_id>[0-9]+) (?P<field_id>[0-9]+)'),
        ...
        "FillInstInfo": re.compile(prefix + r'Prof Fill Inst Info (?P<op_id>[0-9]+) (?P<dst_inst>[a-f0-9]+) (?P<fevent>[a-f0-9]+) (?P<num_fields>[0-9]+)'),
