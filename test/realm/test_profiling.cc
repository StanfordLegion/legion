...
int main(int argc, char **argv)
{
  ...
  std::chrono::time_point<std::chrono::steady_clock> t1_sys = std::chrono::steady_clock::now();
  ...
  std::chrono::time_point<std::chrono::steady_clock> t2_sys = std::chrono::steady_clock::now();
